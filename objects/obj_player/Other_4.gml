...
if (object_index != obj_player2 || global.coop == true)
{
	...
	{
		case "A":
			rd_send_to_door(obj_doorA);
			break;
		case "B":
			rd_send_to_door(obj_doorB);
			break;
		case "C":
			rd_send_to_door(obj_doorC);
			break;
		case "D":
			rd_send_to_door(obj_doorD);
			break;
		case "E":
			rd_send_to_door(obj_doorE);
			break;
		case "F":
			rd_send_to_door(obj_doorF);
			break;
		case "G":
			rd_send_to_door(obj_doorG);
			break;
		default:
			break;
	}
